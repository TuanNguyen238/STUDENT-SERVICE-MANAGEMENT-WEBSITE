		...
		<div class="row flex-nowrap">
			...
			<div
				...
				<fieldset class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" value="${quanTriVien.getHoTen()}" name="hoTen"
				...
				<fieldset class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" value="${quanTriVien.StringGetNgaySinh()}"
				...
				<fieldset class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" value="${quanTriVien.getGioiTinh()}"
			...
			<div
				...
				<fieldset class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" value="${quanTriVien.getEmail()}" name="email"
							required="required" readonly>
					</div>
				</fieldset>
				<fieldset class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" value="${quanTriVien.getSoDienThoai()}"
				...
				<fieldset class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" value="${quanTriVien.getDiaChi()}"
							name="diaChi" required="required" readonly>
					</div>
				</fieldset>
				<a class="form-group"
					href="<%=request.getContextPath()%>/admin?action=changeinfo">Cập
