	...
	<div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bl-color">
		<div
			...
			<ul
				...
				<li class="nav-item"><a href="<%=request.getContextPath()%>/student?action=info"
				...
				<li class="nav-item"><a href="<%=request.getContextPath()%>/swpoint?action=info"
					class="nav-link align-middle px-0"> <i class="fs-4 bi-house"></i>
						<span class="ms-1 d-none d-sm-inline text-white">Điểm CTXH</span>
				</a></li>
				<li class="nav-item"><a href="<%=request.getContextPath()%>/certification?action=info"
					class="nav-link align-middle px-0"> <i class="fs-4 bi-house"></i>
						<span class="ms-1 d-none d-sm-inline text-white">Giấy Xác Nhận</span>
				</a></li>

				<li class="nav-item"><a href="<%=request.getContextPath()%>/question?action=info"
					class="nav-link align-middle px-0"> <i class="fs-4 bi-house"></i>
